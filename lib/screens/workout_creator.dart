...
//I may have to move this list somewhere higher so that it would be visible to the other pages of workout creator
  static List<AbsExercises> generateItems(int numberOfItems) {
    bool trigger = false;
    String absTitleOne =
        "Crunches"; // Here we'd change the "Crunches" to String absTitleOne = (variable from some exercise data page)
    String absTitleTwo = "Plank";
    String absTitleThree = "V-Ups";
    String absTitleFour = "Hollow Holds";
    String absTitleFive = "Medicine Ball Slam";

    String absDescriptionOne =
        "Crunches is an abdominal endurance training exercise to strengthen, abdominal muscles. It is similar to a crunch but with fuller range of motion and  additional muscles.";
    String absDescriptionTwo =
        "Focus on closing the distance between your ribs and hips by lifting your shoulders off the floor while maintaining contact between the ground and your lower back. Moving the top half up puts more emphasis on your upper abs. Start with sets of five and work towards 15.";
    String absDescriptionThree =
        "Starting on your back, extend your legs and keep your arms by your side. In one movement, lift your upper-body, arms and legs to balance on your tailbone, forming a V shape. Lower your body down.";
    String absDescriptionFour =
    ...
    String absDescriptionFive =
        "Standing up with your knees slightly bent lift the medicine ball directly over your head with your arms extended. Rise up on the balls of your feet and use your core muscles to throw the ball to the ground as you bend forwards at the waist. Catch the ball and repeat. The motion will not only train your abs but will also give you powerful shoulders.";
    return List<AbsExercises>.generate(numberOfItems, (int index) {
      ...
      return AbsExercises(
        ...
        expandedValue:
            'This is item number $index ThThis is item number $index This is item number $index This is item number $index This is item number $index This is item number $index This is item number $index This is item number $index This is item number $index This is item number $index is is item number $index ',
      );
    });
  }
}
...
class BicepsExercises {
  ...
  static List<BicepsExercises> generateItems(int numberOfItems) {
    ...
    String descriptionThree =
        "If you're doing these after barbell or cable curls, emphasize the difference by performing Zottmans, or take bilateral seated curls to fatigue and then extend the set by switching to unilateral curls.";
    String descriptionFour =
        "If you train back with biceps, this exercise could make a great bridge movement between the two body parts for 3-4 sets of 8-12 reps. It can also be your primary upper-back and biceps move in a home workout if you take a few sets to failure, like in strength coach Paul Carter's program Jacked at Home: Body-weight Muscle-Building Workouts.";
    String descriptionFive =
        "Include it in your back routine, or as a bridge exercise when training back and biceps together. Go fairly heavy and train in the classic muscle-building rep range of 8-12 reps.";
...
//I may have to move this list somewhere higher so that it would be visible to the other pages of workout creator
  static List<TricepsExercises> generateItems(int numberOfItems) {
    ...
    String descriptionOne =
        "After warming up your elbows, perform 3-4 sets for 8-12 reps as the first or second exercise in your routine. Don't be a hero and risk your skull! Hit your reps and it'll help you build tris to match your bis.";
    String descriptionTwo =
    ...
    String descriptionThree =
        "Do this early or in the middle of your workout for 3-4 sets of 6-10 reps, and you'll be convinced this is one of the best arm muscle-building machines out there. Alternately, up the reps to double digits as an upper-arm burnout.";
    String descriptionFour =
...
//I may have to move this list somewhere higher so that it would be visible to the other pages of workout creator
  static List<ChestExercises> generateItems(int numberOfItems) {
    ...
    String descriptionOne =
        "Bench toward the start of your chest workout for heavy sets in lower rep ranges, such as 5-8 reps. There are better moves for high-rep chest burnouts. Vary your grip width and style for more complete chest development.";
    String descriptionTwo =
        "As a primary lift, a few heavy sets of 6-8 can be your bread and butter. As a secondary lift, up it to 8-10. Many chest workouts start with flat-bench movements first, but every so often you should start with inclines, particularly if you're trying to bring up your upper chest.";
    String descriptionThree =
        "Do free-weight presses early in your chest workout because they require more effort and stabilizer muscles than machines. A machine version could be the final heavy exercise in your workout before switching to lighter pump work.";
    String descriptionFour =
...
//I may have to move this list somewhere higher so that it would be visible to the other pages of workout creator
  static List<BackExercises> generateItems(int numberOfItems) {
    ...
    String descriptionOne =
        "If you're a pull-up pro, you can do some light sets as a warm-up. If they're tougher for you, you can treat them more as a strength movement toward the start of your workout. Assisted variations make for great burnouts at the end of a back workout.";
    String descriptionTwo =
        "Do this toward the front half of your workout, especially if you're going to go heavy. Because it's slightly easier on the lower back, you could do it after deadlifts, but stay mindful of using strict form. If you find yourself cheating or struggling to maintain a flat back, a chest-supported row may be a better choice.";
    String descriptionThree =
        "Like machines, cables can be loaded up pretty heavily without overly taxing you. These are best done toward the end of your workout, so don't be afraid to go slightly higher-rep here, like 10-12 or even 12-15 reps.";
    String descriptionFour =
        "Do it about midway through your workout, after your heavy overhand pulls. And don't be afraid to throw on some wrist straps! Your goal is to hammer your back, not be constantly limited by your grip strength.";
    String descriptionFive =
        "When used as a mass-building exercise, it's best placed toward the middle or end of your workout for sets of 8-12 reps. It's great as a pump-focused finishing move, as well.";
...
class _WorkoutCreatorState extends State<WorkoutCreator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Create your workout'),
          centerTitle: true,
                            ...
                            child: OutlinedButton(
                                style: OutlinedButton.styleFrom(
                                  ...
                                  side: const BorderSide(
                                      color: Color(0xFF5650DE), width: 1.5),
                                ),
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            const WorkoutCreatorChooseCategory()),
                                  );
                                },
                                child: const Text(
                                  'Add exercise',
                                  style: TextStyle(color: Color(0xFF5650DE)),
                                )),
                          ),
                        ]),
                                        ...
                                        onPressed: () {
                                          if (_formKey.currentState!
                                            ...
                                            ElegantNotification.error(
                                              ...
                                              description: const Text(
                                                  'Make sure that you have a correct workout name and workouts.'),
                                            ).show(context);
                                          }
                                        },
...
class WorkoutCreatorChooseCategory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Select exercise category'),
        centerTitle: true,
        backgroundColor: const Color(0xFF5650DE),
      ),
      body: Center(
                        ...
                        child: GestureDetector(
                          ...
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        const WorkoutCreatorExercisesAbs()));
                          },
                        ),
                      ),
                    ),
                    ...
                    child: GestureDetector(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                  color:
                                      const Color(0xff9d9898).withOpacity(0.1),
                                  blurRadius: 4,
                                  offset: const Offset(2, 7))
                            ]),
                        child: GridTile(
                      ...
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    const WorkoutCreatorExercisesBiceps()));
                      },
                    ),
                  ),
                )
                      ...
                      child: GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      const WorkoutCreatorExercisesTriceps()));
                        },
                      ),
                    ),
                  )
                      ...
                      child: GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      const WorkoutCreatorExercisesChest()));
                        },
                      ),
                    ),
                  )
                      ...
                      child: GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      const WorkoutCreatorExercisesBack()));
                        },
                      ),
                    ),
                  )
                      ...
                      child: GestureDetector(
                            ...
                            header: Padding(
                              ...
                              child: Center(
                                child: SizedBox(
                                    height: 150,
                                    width: 150,
                                    child: Image.asset("assets/images/legs.png",
                                        scale: 10)),
                              ),
                            ),
                            child: Padding(
                        ...
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      const WorkoutCreatorExercisesLegs()));
                        },
                      ),
                    ),
                  )
...
class WorkoutCreatorExercisesAbs extends StatefulWidget {
  ...
  @override
  State<WorkoutCreatorExercisesAbs> createState() =>
      _WorkoutCreatorExercisesAbsState();
}

class _WorkoutCreatorExercisesAbsState
    extends State<WorkoutCreatorExercisesAbs> {
      ...
      body: Center(
        ...
        children: <Widget>[
          ...
          TextButton(
              style: const ButtonStyle(
                backgroundColor:
                    MaterialStatePropertyAll<Color>(Color(0xFF5650DE)),
              ),
              onPressed: () {
...
class WorkoutCreatorExercisesBiceps extends StatefulWidget {
  ...
  @override
  State<WorkoutCreatorExercisesBiceps> createState() =>
      _WorkoutCreatorExercisesBicepsState();
}

class _WorkoutCreatorExercisesBicepsState
    extends State<WorkoutCreatorExercisesBiceps> {
        ...
        children: <Widget>[
          ...
          TextButton(
              ...
              onPressed: () {
                ...
                if (_data[4].value == true) {
                  _WorkoutCreatorState.workoutList
                      .add("Reverse-Grip Barbell Row");
                }
                _WorkoutCreatorState.notif.value += 1;
                const snackBar = SnackBar(
                  content: Text('Added exercises to the workout!'),
...
class WorkoutCreatorExercisesTriceps extends StatefulWidget {
  ...
  @override
  State<WorkoutCreatorExercisesTriceps> createState() =>
      _WorkoutCreatorExercisesTricepsState();
}

class _WorkoutCreatorExercisesTricepsState
    extends State<WorkoutCreatorExercisesTriceps> {
        ...
        children: <Widget>[
          ...
          TextButton(
              ...
              onPressed: () {
                ...
                if (_data[4].value == true) {
                  _WorkoutCreatorState.workoutList
                      .add("Dumbbell Overhead Triceps Extension");
                }
                _WorkoutCreatorState.notif.value += 1;
                const snackBar = SnackBar(
                  content: Text('Added exercises to the workout!'),
...
class WorkoutCreatorExercisesChest extends StatefulWidget {
  ...
  @override
  State<WorkoutCreatorExercisesChest> createState() =>
      _WorkoutCreatorExercisesChestState();
}

class _WorkoutCreatorExercisesChestState
    extends State<WorkoutCreatorExercisesChest> {
...
class WorkoutCreatorExercisesBack extends StatefulWidget {
  ...
  @override
  State<WorkoutCreatorExercisesBack> createState() =>
      _WorkoutCreatorExercisesBackState();
}

class _WorkoutCreatorExercisesBackState
    extends State<WorkoutCreatorExercisesBack> {
        ...
        children: <Widget>[
          ...
          TextButton(
              ...
              onPressed: () {
                ...
                if (_data[3].value == true) {
                  _WorkoutCreatorState.workoutList
                      .add("Single-Arm Smith Machine Row");
                }
                if (_data[4].value == true) {
...
class WorkoutCreatorExercisesLegs extends StatefulWidget {
  ...
  @override
  State<WorkoutCreatorExercisesLegs> createState() =>
      _WorkoutCreatorExercisesLegsState();
}

class _WorkoutCreatorExercisesLegsState
    extends State<WorkoutCreatorExercisesLegs> {
