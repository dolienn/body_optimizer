class Parts {
  ...
  Parts({required this.title, required this.image, required this.exercises});
}

class PartsCreator {
  final List<Parts> parts = [
    Parts(title: "Abs", image: "assets/images/abs.png", exercises: ''),
    Parts(title: "Biceps", image: "assets/images/biceps.png", exercises: ''),
    Parts(title: "Triceps", image: "assets/images/triceps.png", exercises: ''),
    Parts(title: "Chest", image: "assets/images/chest.png", exercises: ''),
    Parts(title: "Back", image: "assets/images/back.png", exercises: ''),
    Parts(title: "Legs", image: "assets/images/legs.png", exercises: ''),
    Parts(
        title: "Shoulders",
        image: "assets/images/shoulders.png",
        exercises: ''),
    Parts(title: "Rear", image: "assets/images/rear.png", exercises: ''),
  ];
}
...
class ExercisesList {
  ...
  var excAbsInstruction2 =
      "Grab the bar and hang, your body still and your legs straight.Slowly draw your knees up to your chestOnce you have raised your knees as high as possible, lower your legs and repeat. Duration of these movements should be slow so that you do not utilize momentum, enabling you to get the most out of the exercise.Duration of these movements should be slow so that you do not utilize momentum, enabling you to get the most out of the exercise.";
  var excAbsVideo2 = 'assets/videos/hanging-knee-raises.gif';

  var excAbsName3 = 'Forearm Plank';
  var excAbsInstruction3 =
  ...
  var excBicepsInstruction3 =
      "Stand up straight with a kettlebell in both hands in front of your pelvis. Raise the kettlebell bending your arms at the elbow until the kettlebell is level with your chest. Lower to the starting position and repeat.";
  var excBicepsVideo3 = 'assets/videos/goblet-curl.gif';

  //---------TRICEPS--------

  var excTricepsName1 = 'Cable Push Down';
  var excTricepsInstruction1 =
      "You can use any attachment for this. The cable should be set all the way at the top of the machine. Make sure to keep your upper arm glued at your side. Extend your elbows until you feel your triceps contract.";
  var excTricepsVideo1 = 'assets/videos/cable-push-down.gif';

  var excTricepsName2 = 'Cross Pushdown';
  var excTricepsInstruction2 =
      'Either use two handles or no attachment at all. Both sides of the cable crossover should be set to the top. Stand in the center of the machine holding each Cable in the opposing hand. Your upper arm should be at a 45 degree angle with your torso. Extend your elbows until you feel a contraction and then return to the starting position';
  var excTricepsVideo2 = 'assets/videos/cross-pushdown.gif';

  var excTricepsName3 = 'Cable Overhead Tricep Ext';
  var excTricepsInstruction3 =
      'You can use any attachment. The cable should be all the way to the bottom of the machine. Face away from the machine. Point your elbows straight up toward the ceiling. From there, extend your elbows until your fists are pointed straight toward the ceiling.';
  ...
  var excChestInstruction3 =
      'Lay flat on the bench with your feet on the ground. With straight arms unrack the bar. Lower the bar to your mid chest. Raise the bar until you have locked your elbows';
  var excChestVideo3 = 'assets/videos/barbell-bench-press.gif';

  //---------BACK--------

  var excBackName1 = 'Pull Ups';
  var excBackInstruction1 =
      'Grasp the bar with an overhand grip, arms and shoulders fully extended. Pull your body up until your chin is above the bar. Lower your body back to starting position.';
  var excBackVideo1 = 'assets/videos/pull-ups.gif';

  var excBackName2 = 'Upright Row';
  var excBackInstruction2 =
      'Use a handle attachment with the cable set to the bottom of the machine. Pull your elbows straight up toward the ceiling until the attachment is just below your chin then extend until your elbows are fully extended.';
  var excBackVideo2 = 'assets/videos/upright-row.gif';

  var excBackName3 = 'Cable Pullover';
  var excBackInstruction3 =
